...
class TestModeTest {
    ...
    @Test
    @DisplayName("Error message if login with wrong login")
    ...
    @Test
    @DisplayName("Successful login under an active registered user")
    ...
    @Test
    @DisplayName("Error message if login with an incorrect password")
    ...
    @Test
    @DisplayName("Error message if logged in as an unregistered user")
